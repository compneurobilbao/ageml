...
ModelRegistry.register("ridge", linear_model.Ridge,
                      hyperparameter_ranges={"alpha": [-3, 3]},
                      hyperparameter_types={"alpha": "log"})
ModelRegistry.register("lasso", linear_model.Lasso,
                      hyperparameter_ranges={"alpha": [-3, 3]},
                      hyperparameter_types={"alpha": "log"})
ModelRegistry.register("linear_svr", svm.SVR,
                      hyperparameter_ranges={"C": [-3, 3], "epsilon": [-3, 3]},
                      hyperparameter_types={"C": "log", "epsilon": "log"})
ModelRegistry.register("xgboost", XGBRegressor,
...
ModelRegistry.register("rf", RandomForestRegressor,
                      hyperparameter_ranges={
                          "n_estimators": [1, 100],
                          "max_depth": [1, 100],
...
ScalerRegistry.register("power", PowerTransformer,
                       hyperparameters={"method": ["yeo-johnson", "box-cox"]})
ScalerRegistry.register("quantile", QuantileTransformer,
                       hyperparameters={
                           "n_quantiles": [10, 1000],
...
MetricRegistry.register("regression_metrics", lambda y_true, y_pred: (
...
class AgeML:
    ...
    def set_hyperparameter_grid(self):
        ...
        """
        param_grid = {}
        model_info = ModelRegistry.get(self.model_type)
        conditions = [
    ...
    def set_scaler(self, norm, **kwargs):
        ...
        **kwargs: to input to sklearn scaler object"""
        ...
        if norm in ["no", "None"]:
            ...
            scaler_info = ScalerRegistry.get(norm)
            self.scaler = scaler_info['class'](**kwargs)
    ...
    def set_model(self, model_type, **kwargs):
        ...
        **kwargs: to input to sklearn model object"""
        ...
        model_info = ModelRegistry.get(model_type)
        self.model = model_info['class'](**kwargs)
    ...
    def calculate_metrics(self, y_true, y_pred):
        ...
        return MetricRegistry.get("regression_metrics")(y_true, y_pred)
    ...
    def fit_age(self, X, y):
        ...
        for cv_pipeline in pipelines:
            ...
            for i, (train, test) in enumerate(kf_cv.split(X)):
